                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <!-- Bootstrap tab status per tahap -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Status Tahapan Proposal</h5>
                                                    </div>
                                                    <div class="card-block">
                                                        <div class="row m-b-30">
                                                            <div class="col-lg-12 col-xl-12">
                                                                <div class="sub-title">Tahapan Proposal</div>
                                                                <!-- Nav tabs -->
                                                                <ul class="nav nav-tabs md-tabs" role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" data-toggle="tab"
                                                                            href="#pengajuan" role="tab">
                                                                            Pengajuan Proposal
                                                                            <span
                                                                                class="badge badge-dark ml-1">{{ $pengajuan }}</span>
                                                                        </a>
                                                                        <div class="slide"></div>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab"
                                                                            href="#review" role="tab">
                                                                            Review oleh Reviewer
                                                                            <span
                                                                                class="badge badge-info ml-1">{{ $review }}</span>
                                                                        </a>
                                                                        <div class="slide"></div>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab"
                                                                            href="#revisi" role="tab">
                                                                            Revisi
                                                                            <span
                                                                                class="badge badge-danger ml-1">{{ $revisi }}</span>
                                                                        </a>
                                                                        <div class="slide"></div>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab"
                                                                            href="#persetujuan" role="tab">
                                                                            ACC
                                                                            <span
                                                                                class="badge badge-warning ml-1">{{ $acc }}</span>
                                                                        </a>
                                                                        <div class="slide"></div>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab"
                                                                            href="#publikasi" role="tab">
                                                                            Publish
                                                                            <span
                                                                                class="badge badge-success ml-1">{{ $publish }}</span>
                                                                        </a>
                                                                        <div class="slide"></div>
                                                                    </li>
                                                                </ul>
                                                                ...
                                                                <div class="tab-content card-block">
                                                                    <div class="tab-pane active" id="pengajuan"
                                                                        role="tabpanel">
                                                                        <p class="m-0">Daftar proposal submit</p>
                                                                    </div>
                                                                    <div class="tab-pane" id="review"
                                                                        role="tabpanel">
                                                                        <p class="m-0">Proposal sedang dalam proses
                                                                            review</p>
                                                                    </div>
                                                                    <div class="tab-pane" id="revisi"
                                                                        role="tabpanel">
                                                                        <p class="m-0">Proposal sedang dalam revisi
                                                                        </p>
                                                                    </div>
                                                                    <div class="tab-pane" id="persetujuan"
                                                                        role="tabpanel">
                                                                        <p class="m-0">Proposal yang sudah accept
                                                                            editor.</p>
                                                                    </div>
                                                                    <div class="tab-pane" id="publikasi"
                                                                        role="tabpanel">
                                                                        <p class="m-0">Proposal yang sudah
                                                                            dipublish.</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @foreach ($allData as $data)
                                                            <div class="col-md-4">
                                                                <div
                                                                    ...
                                                                    <div class="research-cover pdf-icon-container">
                                                                        <i class="fas fa-file-pdf"
                                                                            style="font-size: 80px; color: #e63946; padding-top=65px"></i>
                                                                    </div>
                                                                    <div class="card-block research-body">
                                                                        <h6 class="m-b-0 research-title">
                                                                            {{ $data->judul ?? 'Judul Penelitian' }}
                                                                        </h6>
                                                                        <div class="research-subtitle"> Bidang:
                                                                            @if ($data->source == 'proposal')
                                                                                {{ optional($data->nominal?->pembiayaan?->tema)->first()->tema ?? '-' }}
                                                                            @elseif($data->source == 'proposalx')
                                                                                {{ $data->tema?->tema ?? '-' }}
                                                                            @endif
                                                                            • {{ $data->tahun ?? date('Y') }}
                                                                        </div>
                                                                        ...
                                                                        <div class="research-actions">
                                                                            ...
                                                                            @if ($data->source === 'proposal')
                                                                                <a href="{{ route('proposal.detail', $data->id) }}"
                                                                                    class="btn btn-outline-primary btn-sm">
                                                                                    <i class="fa fa-book m-r-5"></i>
                                                                                    View Jurnal
                                                                                </a>
                                                                            @elseif ($data->source === 'proposalx')
                                                                                <a href="{{ route('proposalx.detail', $data->id) }}"
                                                                                    class="btn btn-outline-primary btn-sm">
                                                                                    <i class="fa fa-book m-r-5"></i>
                                                                                    View Jurnal
                                                                                </a>
