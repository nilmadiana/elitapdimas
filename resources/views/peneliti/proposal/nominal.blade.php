                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form
                                                            action="{{ route('pembiayaan.nominal.store', $pembiayaan->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Total Nominal
                                                                </label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control"
                                                                        name="nominal_akhir"
                                                                        placeholder="Masukkan Nominal Akhir">
                                                                </div>
                                                            </div>
                                                            ...
                                                            @if (in_array($user->role, ['admin', 'jurnal manager', 'bendahara']))
                                                                <div class="form-group row">
                                                                    <label
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select class="form-control" name="status">
                                                                            ...
                                                                            <option value="Belum Cair">Belum Cair
                                                                            </option>
                                                                            <option value="Sebagian Cair">Sebagian Cair
                                                                            </option>
                                                                            <option value="Sudah Cair">Sudah Cair
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                </div>
