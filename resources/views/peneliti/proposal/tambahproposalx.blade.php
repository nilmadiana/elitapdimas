                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="{{ route('proposalx.store') }}" method="POST"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Abstract<span
                                                                        style="color:red">*</span></label>
                                                                <div class="col-sm-10">
                                                                    <textarea name="abstract" id="abstractEditor" rows="5" class="form-control"
                                                                        placeholder="Masukkan abstrak artikel"></textarea>
                                                                </div>
                                                            </div>

                                                            <!-- Referensi -->
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Referensi<span
                                                                        style="color:red">*</span></label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <!-- File PDF -->
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">File PDF<span
                                                                        style="color:red">*</span></label>
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <label for="prodi"
                                                                                        class="col-form-label">PRODI<span
                                                                                            style="color:red">*</span></label>
                                                                                    <input type="text"
                                                                                        id="prodi"
                                                                                        class="form-control"
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <label
                                                                                class="col-form-label d-block">Role<span
                                                                                    style="color:red">*</span></label>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-form-label d-block">
                                                                    <button type="submit"
