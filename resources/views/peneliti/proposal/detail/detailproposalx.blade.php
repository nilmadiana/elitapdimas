                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card table-card">
                                                ...
                                                <div class="card-body space-y-4">
                                                    ...
                                                    <div class="border p-3 rounded mb-3">
                                                        ...
                                                        <p class="fs-5 mb-0">{{ $proposalx->judul }}</p>
                                                    </div>

                                                    <!-- Kata Kunci -->
                                                    <div class="border p-3 rounded mb-3">
                                                        <h5 class="fw-bold mb-1">Kata Kunci</h5>
                                                        <p class="fs-5 mb-0">{{ $proposalx->keyword }}</p>
                                                    </div>
                                                    ...
                                                    <div class="border p-3 rounded mb-3">
                                                        ...
                                                        <ol class="fs-5 mb-0 ps-3">
                                                            <li>{{ $proposalx->referensi }}</li>
                                                        </ol>
                                                    </div>

                                                    <!-- File PDF -->
                                                    <div class="border p-3 rounded mb-3">
                                                        <h5 class="fw-bold mb-1">File proposalx (PDF)</h5>
                                                        @if ($proposalx->file_pdf)
                                                            <embed
                                                                src="{{ asset('storage/' . $proposalx->file_pdf) }}"
                                                    ...
                                                    <div class="border p-3 rounded mb-3">
                                                        ...
                                                        <p class="fs-5 mb-0">{{ $proposalx->comment }}</p>
                                                    </div>
                                                    ...
                                                    <div class="border p-3 rounded mb-3">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered fs-6">
                                                                ...
                                                                <tbody>
                                                                    @forelse ($proposalx->contributorsx as $c)
                                                                        <tr>
                                                                            <td>{{ $c->nama_depan }}</td>
                                        ...
                                        @if (array_intersect($roles, ['Admin', 'Jurnal Manager', 'Editor', 'Reviewer']))
                                            <form action="{{ route('proposalx.updateReview', $proposalx->id) }}"
                                                    ...
                                                    @foreach (['Incomplete', 'Submit', 'Accept Reviewer', 'Reject Reviewer', 'Accept Editor', 'Reject Editor', 'Publish', 'Rejected'] as $statusOption)
                                                        <div class="form-check form-check-inline">
                                                            <input type="radio" class="form-check-input"
                                                                ...
                                                                {{ $proposalx->status == $statusOption ? 'checked' : '' }}>
                                                            <label
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered">
                                                                ...
                                                                <tbody>
                                                                    @forelse($proposalx->commentsx as $review)
                                                                        <tr>
