                                                ...
                                                <div class="card-block">
                                                    <div class="row">
                                                        <div class="col-xl-3 col-md-6">
                                                            ...
                                                            <h5 class="m-b-30 f-w-700">{{ $totalProposalx }}</h5>
                                                        </div>
                                                        <div class="col-xl-3 col-md-6">
                                                            <h6>Proposal Disetujui</h6>
                                                            <h5 class="m-b-30 f-w-700">{{ $totalPublishx }}</h5>
                                                        </div>
                                                        <div class="col-xl-3 col-md-6">
                                                            <h6>Proposal Ditolak</h6>
                                                            <h5 class="m-b-30 f-w-700">{{ $totalRejectedx }}</h5>
                                                        </div>
                                                        <div class="col-xl-3 col-md-6">
                                                            <h6>Proposal Sedang Diproses</h6>
                                                            <h5 class="m-b-30 f-w-700">{{ $totalProsesx }}</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="tab-content tabs card-block">
                                                                        ...
                                                                        <div class="tab-pane active" id="home1"
                                                                            role="tabpanel">
                                                                            <p class="m-0">
                                                                                <strong>Pembiayaan Akhir</strong> adalah
                                                                                skema pembiayaan di mana proses
                                                                                pengajuan proposal dilakukan terlebih
                                                                                dahulu. Setelah proposal disetujui,
                                                                                barulah dilakukan pengajuan dan
                                                                                pencairan dana pembiayaan.
                                                                            </p>
                                                                            <p>
                                                                                Skema ini lebih sesuai untuk kegiatan
                                                                                yang sudah siap secara mandiri dan hanya
                                                                                membutuhkan dana setelah rencana
                                                                                disetujui.
                                                                            </p>
                                                                        </div>

                                                                        <!-- Tab: Pembiayaan Akhir -->
                                                ...
                                                <div class="card-block">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover m-b-0">
                                                            ...
                                                            <tbody>
                                                                @foreach ($proposalsx as $proposalx)
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <h6 class="m-b-0">{{ $proposalx->judul }}
                                                                            </h6>
                                                                        </td>
                                                                        <td>
                                                                            <a href="{{ route('proposalx.detail', $proposalx->id) }}"
                                                                        ...
                                                                        <td>
                                                                            <button class="btn btn-sm btn-outline-info"
                                                                                ...
                                                                                data-bs-target="#modalView{{ $loop->iteration }}">{{ $proposalx->view_count ?? 0 }}
                                                                                View</button>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @if ($proposalx->status === 'Incomplete')
                                                                                <form
                                                                                    action="{{ route('proposalx.submit', $proposalx->id) }}"
                                                                                    method="POST"
                                                                            ...
                                                                            @endif
                                                                            <span id="statusBadge">
                                                                                @switch(strtolower(trim($proposalx->status)))
                                                                                    @case('incomplete')
                                                                                        <span
                                                                        ...
                                                                        <td>
                                                                            @if ($proposalx->nominalx)
                                                                                Pengajuan Nominal:
                                                                                {{ number_format($proposalx->nominalx->nominal, 0, ',', '.') }}
                                                                            @else
                                                                        ...
                                                                        <td>
                                                                            @if (
                                                                                $proposalx->status === 'Incomplete' ||
                                                                                    $proposalx->status === 'Accept Reviewer' ||
                                                                                    $proposalx->status === 'Accept Editor')
                                                                                <a href="{{ route('proposalx.edit', $proposalx->id) }}"
                                                                            ...
                                                                            @if (!$proposalx->nominalx && auth()->check() && count(array_intersect($allowedRoles, $userRoles)) > 0)
                                                                                <a href="{{ route('nominalsx.create', $proposalx->id) }}"
