...
<body>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Proposal</h5>
                                                        <span>Silahkan
                                                            Menambahkan Proposal Anda secara
                                                            <code>lengkap</code></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form action="{{ route('proposal.store') }}" method="POST"
                                                            ...
                                                            <input type="hidden" name="nominal_id"
                                                                value="{{ $nominal_id }}">

                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Judul <span
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Keyword <span
                                                                        style="color:red">*</span></label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="abstractEditor"
                                                                    class="col-sm-2 col-form-label">Abstract <span
                                                                        style="color:red">*</span></label>
                                                                <div class="col-sm-10">
                                                                    <textarea name="abstract" id="abstractEditor" class="form-control" placeholder="Tulis abstrak di sini"
                                                                        rows="6" style="width: 200%;"></textarea>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">File
                                                                    PDF <span style="color:red">*</span></label>
                                                                <i>FILE YANG DIUPLOAD HARUS PDF MAX. 2MB</i>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <textarea id="comment" name="comment" class="form-control" placeholder="Masukkan komentar" rows="3"></textarea>
                                                            </div>
    ...
    <div class="form-group row">
        <div class="col-sm-6">
            ...
            <input type="text" id="nama_depan" class="form-control form-txt-default"
        ...
        <div class="col-sm-6">
            ...
            <input type="text" id="nama_belakang" class="form-control form-txt-default"
