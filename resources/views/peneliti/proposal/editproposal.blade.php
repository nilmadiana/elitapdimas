                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                        ...
                                                        <form action="{{ route('proposal.update', $proposal->id) }}"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="keyword"
                                                                        class="form-control"
                                                                        value="{{ old('keyword', $proposal->keyword) }}"
                                                                        placeholder="Masukkan kata kunci">
                                                                    <b><i>Pisahkan perkata keyword dengan tanda titik
                                                                            koma (;)</i></b>
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="abstractEditor"
                                                                    class="col-sm-2 col-form-label">Abstract </label>
                                                                <div class="col-sm-10">
                                                                    <textarea name="abstract" id="abstractEditor" class="form-control" rows="6"
                                                                        placeholder="Tulis abstrak di sini">{{ old('abstract', strip_tags($proposal->abstract)) }}</textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="referensi"
                                                                        class="form-control"
                                                                        value="{{ old('referensi', $proposal->referensi) }}"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <br>
                                                                    @if ($proposal->file_pdf)
                                                                        <embed
                                                                            src="{{ asset('storage/' . $proposal->file_pdf) }}"
                                                            ...
                                                            <div id="contributor-container">
                                                                @forelse($proposal->contributors as $index => $contributor)
                                                ...
                                                <button type="button" id="add-contributor"
                                                    class="btn btn-outline-success">
                                                    <i class="fas fa-user-plus"></i> Tambah Kontributor
                                                </button>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <textarea id="comment" name="comment" class="form-control" rows="3" placeholder="Masukkan komentar">{{ old('comment', $proposal->comment) }}</textarea>
                                            </div>
