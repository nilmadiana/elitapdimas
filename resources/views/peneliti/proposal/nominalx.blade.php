                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        <form action="{{ route('nominalsx.store') }}" method="POST">
                                                            @csrf
                                                            <input type="hidden" name="proposalx_id"
                                                                value="{{ $proposalx->id }}">

                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Judul
                                                                </label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control"
                                                                        value="{{ $proposalx->judul }}" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            @if (auth()->check() && array_intersect($rolesYangBoleh, $userRoles))
                                                                <div class="form-group row">
                                                                    <label
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select class="form-control" name="status"
                                                                            ...
                                                                            <option value="Proses Pencairan">Proses
                                                                                Pencairan
                                                                            </option>
                                                                            <option value="Pencairan Selesai">Pencairan
                                                                                Selesai
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-sm-2 col-form-label">Komentar</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"
                                                                            name="komentar"
